...
:InstallOrUpdate
start "" /wait "%bin%\..\Installers\Extras\Security\Malwarebytes Anti-Malware.exe"

:FindInstallation
set install_path=
if exist "%programfiles%\Malwarebytes Anti-Malware\mbam.exe" (set "install_path=%programfiles%\Malwarebytes Anti-Malware")
if exist "%programfiles(x86)%\Malwarebytes Anti-Malware\mbam.exe" (set "install_path=%programfiles(x86)%\Malwarebytes Anti-Malware")
